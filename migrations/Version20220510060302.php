 ...
 */
final class Version20220510060302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD idrec INT AUTO_INCREMENT NOT NULL, DROP id, ADD PRIMARY KEY (idrec)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reclamation ADD id INT NOT NULL, DROP idrec');
    }
}
