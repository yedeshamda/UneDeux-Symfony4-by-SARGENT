 ...
 */
final class Version20211020143731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD categorie_id INT DEFAULT NULL, ADD marque_id INT DEFAULT NULL, ADD image_name VARCHAR(255) DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, DROP image, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE datecreation datecreation DATE NOT NULL, CHANGE descriptiontech descriptiontech LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD photo_id INT DEFAULT NULL, ADD nom VARCHAR(255) NOT NULL, ADD prenom VARCHAR(255) NOT NULL, ADD updated_at DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD image VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP categorie_id, DROP marque_id, DROP image_name, DROP updated_at, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE datecreation datecreation DATE DEFAULT NULL, CHANGE descriptiontech descriptiontech VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('DROP INDEX UNIQ_8D93D6497E9E4C8C ON user');
        $this->addSql('ALTER TABLE user DROP photo_id, DROP nom, DROP prenom, DROP updated_at');
    }
}
